...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<deep_merge>, [">= 1.2.1", "~> 1.2"])
      s.add_runtime_dependency(%q<activesupport>, [">= 3.0"])
      s.add_runtime_dependency(%q<dry-validation>, ["< 1.0.0", ">= 0.12.2", "~> 0.12"])
      s.add_development_dependency(%q<rails>, [">= 5.2.2", "~> 5.2"])
      ...
      s.add_development_dependency(%q<mdl>, [">= 0.5.0", "~> 0.5"])
      s.add_development_dependency(%q<rubocop>, ["~> 0.62"])
    else
      s.add_dependency(%q<deep_merge>, [">= 1.2.1", "~> 1.2"])
      s.add_dependency(%q<activesupport>, [">= 3.0"])
      s.add_dependency(%q<dry-validation>, ["< 1.0.0", ">= 0.12.2", "~> 0.12"])
      s.add_dependency(%q<rails>, [">= 5.2.2", "~> 5.2"])
      ...
      s.add_dependency(%q<mdl>, [">= 0.5.0", "~> 0.5"])
      s.add_dependency(%q<rubocop>, ["~> 0.62"])
    end
  else
    s.add_dependency(%q<deep_merge>, [">= 1.2.1", "~> 1.2"])
    s.add_dependency(%q<activesupport>, [">= 3.0"])
