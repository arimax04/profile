...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dry-logic>, [">= 0.5.0", "~> 0.5"])
      s.add_runtime_dependency(%q<dry-types>, [">= 0.14", "~> 0.14"])
      ...
      s.add_dependency(%q<dry-logic>, [">= 0.5.0", "~> 0.5"])
      s.add_dependency(%q<dry-types>, [">= 0.14", "~> 0.14"])
